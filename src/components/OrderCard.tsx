...
import { Coffee, Phone, User, Calendar, DollarSign } from 'lucide-react'
...
export function OrderCard({ order }: OrderCardProps) {
  ...
  return (
    <Card className="w-full shadow-md hover:shadow-lg transition-shadow border-warm-roast/20 overflow-hidden group">
      <CardHeader className="bg-white-pergamino border-b border-warm-roast/10 pb-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-expresso">${Number(order.total_price).toFixed(2)}</div>
